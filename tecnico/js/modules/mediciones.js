...
// Gestión de mediciones por tipo de servicio
...
// ============================================================
// RENDERIZAR FORMULARIO DE MEDICIONES SEGÚN SERVICIO
// ============================================================
...
// ============================================================
// OBTENER MEDICIONES ACTUALES DEL FORMULARIO
// ============================================================
...
// ============================================================
// LIMPIAR CAMPOS DE MEDICIONES
// ============================================================

export function limpiarMediciones(servicioTipo) {
    if (servicioTipo === 'PISCINA') {
        const cloro = document.getElementById('medCloro')
        const ph = document.getElementById('medPh')
        const temp = document.getElementById('medTemp')
        if (cloro) cloro.value = ''
        if (ph) ph.value = ''
        if (temp) temp.value = ''
    } else if (servicioTipo === 'JARDIN') {
        const altura = document.getElementById('medAltura')
        const estado = document.getElementById('medEstado')
        if (altura) altura.value = ''
        if (estado) estado.value = ''
    } else {
        const obs = document.getElementById('medObservaciones')
        if (obs) obs.value = ''
    }
}

// ============================================================
// VALIDAR QUE HAYA AL MENOS UNA MEDICIÓN
// ============================================================
...
export function validarMediciones(mediciones, servicioTipo) {
    ...
    if (servicioTipo === 'PISCINA') {
        return mediciones.cloro || mediciones.ph || mediciones.temperatura
    } else if (servicioTipo === 'JARDIN') {
        return mediciones.altura || mediciones.estado
    } else {
...
// ============================================================
// OBTENER MEDICIONES DE UNA TAREA
// ============================================================
...
// ============================================================
// FORMATEAR MEDICIÓN PARA MOSTRAR
// ============================================================
